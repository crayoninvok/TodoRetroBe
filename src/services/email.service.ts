...
const EMAIL_PASS =
  process.env.EMAIL_PASS || "your-email-password-or-app-password";
...
const renderTemplate = async (
  ...
  try {
    ...
    const templatePath = path.resolve(`./src/templates/${template}.hbs`);
...
export const sendVerificationEmail = async (
  ...
  try {
    ...
    const html = await renderTemplate("verification", context);
...
export const sendPasswordResetEmail = async (
  ...
  try {
    // Render the email template
    const html = await renderTemplate("reset-password", context);
